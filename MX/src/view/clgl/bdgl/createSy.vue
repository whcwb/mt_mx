      ...
      return {
        ...
        formItemGroup: [
          [
            ...
            {title: '起保时间', key: 'sbQbsj', type: 'date'},
            {title: '终保时间', key: 'sbZbsj', type: 'date'},
            {title: '投保公司', key: 'sbTbgs', minWidth: 120},
            {title: '联系电话', key: 'sbBxdh', minWidth: 120},
    ...
    methods: {
      ...
      getData() {
        this.$http.post('api/carbx/clbxzt', {'clId': this.formItem.clId}).then((res) => {
          if (res.code == 200) {
            this.formItem.sbQbsj = res.result.bxrq
            this.formItem.sbZbsj = res.result.bxz
