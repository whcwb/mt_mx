  ...
  export default {
    ...
    data() {
      return {
        ...
        showModal: true,
        editMode: true,
        saveUrl: this.apis.carcq.clbf,
        formItem: {},
        ruleInline: {},
        fileGroup: {
          propertyFileurl: {type: '产权',urlType: 'dzdDjzFileurl',urlList: [],uploadUrl: this.apis.upFile + '?targetPath=car'},
        },
        formItemGroup: [
          [
            {title: '经办人', key: 'jbr', required: true},
            {title: '经办人手机号码', key: 'jbrDn', required: true},
            {title: '报废金额', key: 'bfjl', required: true},
            {title: '备注', key: 'bz'},
          ],
        ],
        params: {
