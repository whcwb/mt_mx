  ...
  <div>
    <Modal
      ...
      <div :style="{height:AF.getPageHeight()-480 +'px',overflow:'auto',width:'100%'}">
        <div class="body" id="kmsMxtj" style="width: 100%">
          <div style="width: 700px;margin: auto">
            <div style="width: 100%">
              <div class="header" style="text-align: center">
                <span style="font-size: 20px;font-weight: 600">科目三训练明细表</span>
              </div>
              <div><span style="font-size:12px">统计时间范围：{{timeF(minTime)}}至{{timeF(maxTime)}}</span></div>
              <div>
...
<script>
  ...
  export default {
    ...
    methods: {
      ...
      doPrint(how) {
        var v = this
        this.SetPprintInnerHTML(document.getElementById("kmsMxtj").innerHTML)
        setTimeout(()=>{
          var myDoc = {
