...
<!--    <Menu mode="horizontal" :active-name="activeName" theme="light" @on-select="MenuClick">-->
<!--      <MenuItem name="1">-->
<!--        科二模训-->
<!--      </MenuItem>-->
<!--      <MenuItem name="2">-->
    ...
    data() {
      return {
        ...
        tableColumns: [
          ...
          //     align: 'center'
          // },
          {title: '教练姓名', key: 'jlXm', searchKey: 'jlXmLike'},
          ...
          {title: '开始时间', key: 'kssj', },
          {title: '结束时间', key: 'jssj', searchType: 'daterange',},
          {title: '时长(分钟)', key: 'sc', defaul: '0'},
          // {title: '学员数量', key: 'xySl', minWidth: 90, defaul: '0'},
          // {title: '计费类型', key: 'lcLx',minWidth:90,dict:'ZDCLK1048'},
          {title: '练车费用(元)', key: 'lcFy', append: '元', defaul: '0'},
          {
            title: '订单状态', key: 'zfzt',
            render: (h, p) => {
              if (p.row.zfzt == '00') {
            ...
            {title: '凭证', key: 'pz',},
          {
            title: '操作', fixed: 'right', render: (h, p) => {
              let buttons = [];
              buttons.push(this.util.buildButton(this, h, 'Default', 'ios-print', '补打', () => {
