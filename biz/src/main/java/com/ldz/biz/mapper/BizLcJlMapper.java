...
public interface BizLcJlMapper extends Mapper<BizLcJl> {
    ...
    @Select(" select * from biz_lc_jl where id in (SELECT a.id from biz_lc_jl a left join biz_lc_wxjl b on  a.jl_Id = b.id where b.ye > 0 and ((a.jssj = '' or a.jssj is null) or a.zfzt = '00'))  ")
